...
// @description    自动缩放页面,可以为所有页面指定缺省的缩放值.转制自alice0775所做扩充套件.
...
// @note          2016/08/28 modified by skofkyo 调整按钮代码,样式
// @note          2016/08/27 modified by skofkyo 修改为网址列按钮 修正按钮滚轮事件
// @note          2013/07/15 modified by lastdream2013 修正恢复上次关闭网页时有可能在第一个页面失效的问题
// @note          2013/07/11 稍做修正，增加右键点击菜单项设置所有页面缺省的缩放率
// ==/UserScript==
//@11/22 第一版
//@1/2/13 第二版
var FullZoomConfig = new function() {
    ...
    this.zoomValues = "0.8,0.85,0.9,0.95,1,1.05,1.1,1.15,1.2,1.25,1.30,1.35,1.4,1.5,1.6,1.7,1.8,1.9,2";
    //label
...
var fullZoomBtn = {
    ...
    onPopupShowing: function(event, useFullZoom) {
        ...
        for (var i = 0; i < arr.length; i++) {
            ...
            menuitem.setAttribute('tooltiptext', "左键点击为设置当前页面缩放率，右键点击设置为所有页面的缺省缩放率");
