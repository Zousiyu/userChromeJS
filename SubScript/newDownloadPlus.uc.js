...
// @author	Kelo 再次修改集成  (w13998686967、ywzhaiqi、黒仪大螃蟹、Alice0775、紫云飞)
// @charset	UTF-8
...
// @version	2015.10.01 添加"重启浏览器下载皮肤不删除记录" 功能，增强"Hash 计算"功能
// @version	2015.09.19 修复"另存为..."的一个错误
// @version	2015.05.09 优化代码，添加"Hash 计算功能"
// @version	2015.05.07 使用黒仪大螃蟹的最新"从硬盘中删除"代码  增加"下载皮肤显示下载速度"功能
...
(function() {
	...
	var downloadPlus = {
			...
			xul = '<?xml version="1.0"?><?xml-stylesheet href="chrome://global/skin/" type="text/css"?>\
					...
					<prefpane id="main" flex="1">\
						...
						<groupbox>\
							...
							<checkbox id="downloadFileSize" label="精确显示文档大小" preference="downloadFileSize"/>\
							<checkbox id="autoClose_blankTab" label="自动关闭下载产生的空白标签" preference="autoClose_blankTab"/>\
							<checkbox id="download_speed" label="下载皮肤显示下载速度" preference="download_speed"/>\
							<checkbox id="dontRemoveFinishedDownloads" label="下载皮肤是否不删除记录" tooltiptext="火狐在重启后会自动删除下载皮肤的下载记录，这个选项能保存这些记录" oncommand="_changeStatus(event)" preference="dontRemoveFinishedDownloads"/>\
							...
							<hbox align="center" class="indent">\
								...
								<textbox id="dontRemoveFinishedDownloads_MinStoreThreshold" type="number" preference="dontRemoveFinishedDownloads_MinStoreThreshold" style="width:125px" tooltiptext="当下载皮肤中的数量大于这个数字时，才会保存这些下载记录"/>\
							</hbox>\
						</groupbox>\
						<groupbox>\
							<caption label="下载界面"/>\
							...
							<checkbox id="download_dialog_doubleclicksaveL" label="下载弹出窗口双击保存文档项执行下载" preference="download_dialog_doubleclicksaveL"/>\
						            <checkbox id="download_dialog_doubleclickanyW" label="下载弹出窗口任何地方双击执行下载" preference="download_dialog_doubleclickanyW"/>\
						</groupbox>\
						<groupbox>\
							<caption label="其他"/>\
							<checkbox id="new_Download" label="新建下载 （主界面、收藏库）"  tooltiptext="修改暂时需重启生效，很快会更新" oncommand="_changeStatus(event)" preference="new_Download"/>\
							<hbox align="center" class="indent">\
							            <checkbox align="center" id="new_Download_popups" label="是否弹窗"  preference="new_Download_popups"/>\
							</hbox>\
							<checkbox id="downloadsPanel_removeFile" label="从硬盘中删除 （主界面、收藏库）" tooltiptext="修改暂时需重启生效，很快会更新" preference="downloadsPanel_removeFile"/>\
							<checkbox id="download_checksum" label="Hash 计算（主界面、收藏库）" preference="download_checksum"/>\
							<hbox align="center">\
							            ...
							            <menulist preference="save_And_Open_RorL" id="save_And_Open_RorL" style="width:120px">\
								            <menupopup>\
									            <menuitem label="打开所在文档夹" value="0"/>\
									            <menuitem label="打开文档" value="1"/>\
								            </menupopup>\
							            </menulist>\
							</hbox>\
							...
							<hbox align="center" class="indent">\
									...
									<checkbox align="center" id="download_dialog_changeName_locking" label="锁定保存文档按钮"  preference="download_dialog_changeName_locking"/>\
							</hbox>\
						</groupbox>\
						<hbox flex="1">\
		...
		download_dialog_changeName: function(enable) {
			//注:同时关闭改名和下拉菜单会导致下载文档的文档名不显示(非要关闭请默认在28行最前面加//来注释掉该功能)
			if (!enable) return;
	...
	var Download = (function() {
		...
		exports.promptForFile = function(defaultString) {
			...
			fp.init(window, "请输入要保存的文档名...", nsIFilePicker.modeSave);
