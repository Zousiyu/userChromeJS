...
window.addEventListener('DOMContentLoaded', function (event) {
    ...
    win = doc.defaultView;
//2016年4月22日 00:25:43修改支持ff44+版本
    if (!win.gClipboardHelper) win.gClipboardHelper = Components.classes["@mozilla.org/widget/clipboardhelper;1"].getService(Ci.nsIClipboardHelper);

    if (!win.gPrefBranch) win.gPrefBranch = Services.prefs;
//以上为修改内容
